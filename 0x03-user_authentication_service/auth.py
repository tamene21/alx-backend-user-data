...
class Auth:
    ...
    def get_reset_password_token(self, email: str) -> str:
        """Takes string email argument, Returns string
    ...
    def update_password(self, reset_token: str, password: str) -> str:
        """Takes reset_token and password string
        returns None
        Use reset_token to find corresponding user, if doesn't exist
        raise ValueError if exists, hash password and update user
        hashed_password
        """
